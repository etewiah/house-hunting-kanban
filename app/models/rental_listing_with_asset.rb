# Scenic View!
# -- rails generate scenic:view rental_listing_with_asset
# or better:
# -- rails generate scenic:model rental_listing_with_asset
class RentalListingWithAsset < ApplicationRecord
  ...
  has_many :listing_photos, -> { order 'sort_order asc' }, class_name: "RentalListingPhoto", foreign_key: 'rental_listing_id'
  # has_many :features, class_name: "FeatureRef", foreign_key: 'rental_listing_id'
  has_many :notes, class_name: "Note", foreign_key: 'rental_listing_id'
  ...
  def mob_atts
    ...
    I18n.available_locales.each do |locale|
      ...
      # for above get error:
      # undefined method `mobility_attributes' for #<RentalListingWithAsset:0x00007fcb19de1a98>
      RentalListingWithAsset.mobility_attributes.each do |attr|
